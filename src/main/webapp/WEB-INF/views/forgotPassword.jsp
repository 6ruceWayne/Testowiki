...
<body>
	...
	<form:form method="POST" modelAttribute="user"
		action="${contextPath}/forgotPassword" class="form-signin">
		<div class="container">
			<div class="form-group">
				<label for="usr"><spring:message
						code="your.nickname.or.email" /></label> <input type="text"
					class="form-control" id="usr" name="user">
			</div>
